...
import com.example.diuride.databinding.ActivityUserPolyline2Binding;
...
public class UserPolylineActivity2 extends FragmentActivity implements OnMapReadyCallback {
    ...
    FirebaseAuth mAuth;
    double passengerLat,passengerLon,riderLat,riderLon;

    userLocationModel singleUserLocation;
    String url;

    private ActivityUserPolyline2Binding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityUserPolyline2Binding.inflate(getLayoutInflater());
        ...
        binding.PassengerFoundBTN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Dialog dialog1 = new Dialog(UserPolylineActivity2.this);
                dialog1.setContentView(R.layout.successfulfindrideriderdialog);
                dialog1.setCancelable(false);
                dialog1.show();
                AppCompatButton PassengerFound = dialog1.findViewById(R.id.founPassenger);
                AppCompatButton Nobtn = dialog1.findViewById(R.id.notFoundr);

                PassengerFound.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        mDB.collection("OnGoingRide").document(Objects.requireNonNull(mAuth.getCurrentUser()).getUid()).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful())
                                {
                                    ...
                                    mDB.collection("RiderNotiList").document(mAuth.getCurrentUser().getUid()).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful())
                                            {
                                    ...
                                    startActivity(new Intent(UserPolylineActivity2.this,SuccessFullRIdeShare.class));
                                    finish();
                                }
                ...
                Nobtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(UserPolylineActivity2.this, "!", Toast.LENGTH_SHORT).show();
                        dialog1.dismiss();
                    }
                });
        ...
        binding.cancelRideButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AppCompatButton Notcancelbtn = dialog1.findViewById(R.id.notCancelRide);

                CancelRide.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        //send notification to the rider.
                        mDB.collection("Users").document(passengerID).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                            @Override
                            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                ...
                                if(task.isSuccessful())
                                {
                                    ...
                                    if(ob!=null) {
                                        ...
                                        FcmNotificationSender notificationSender = new FcmNotificationSender(ob.getFCMtoken(),"Ride Canceled","Rider Canceled the Ride Offer",UserPolylineActivity2.this,"editPro");
                                        ...
                                        mDB.collection("OnGoingRide").document(passengerID).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if(task.isSuccessful())
                                                {
                                        ...
                                        mDB.collection("RideList").document(mAuth.getCurrentUser().getUid()).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if(task.isSuccessful())
                                                {
                                                    Toast.makeText(UserPolylineActivity2.this, "Ride Canceled!", Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
...
//                                        Intent intent = new Intent(UserPolylineActivity2.this,MainActivity.class);
//                                        startActivity(intent);
                ...
                Notcancelbtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(UserPolylineActivity2.this, "!", Toast.LENGTH_SHORT).show();
                        dialog1.dismiss();
        ...
        mDB.collection("OnGoingRide").document(Objects.requireNonNull(mAuth.getCurrentUser()).getUid()).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if(task.isSuccessful())
                {
                    ...
                    {
                        Toast.makeText(UserPolylineActivity2.this, "No Ride Found!", Toast.LENGTH_SHORT).show();
                    }
                }
...
//        Toast.makeText(this, ""+riderID, Toast.LENGTH_SHORT).show();
    ...
    private void showCallDialogRider() {
        ...
        call.setInvitees(Collections.singletonList(new ZegoUIKitUser(passengerID)));
    ...
    public void startCallServiceAsRider()
    {
...
//        url = "https://maps.googleapis.com/maps/api/directions/json?origin="+riderLat+","+riderLon+"&destination="+passengerLat+","+passengerLon+"&mode="+mode+"&key=AIzaSyApl3I1wwymJg1Y_XvJDGwzEDuPsOIfitg";
...
//                                    .title("Start Location"));
                           ...
                           // Toast.makeText(UserPolylineActivity2.this, "No route find", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                       // Toast.makeText(UserPolylineActivity2.this, "No route find", Toast.LENGTH_SHORT).show();
                    }
        ...
        mDB.collection("OnGoingRide").document(Objects.requireNonNull(mAuth.getCurrentUser()).getUid()).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if(task.isSuccessful())
                {
                    ...
                    {
                        stopLocationRunnable();
                        startActivity(new Intent(UserPolylineActivity2.this,MainActivity2.class));
                        finish();
